...
from cvae_model import SentenceCVAE
    ...
    for epoch in range(args.epochs):
        ...
        for split in splits:
            ...
            for iteration, batch in enumerate(data_loader):
                #Skip batches with words out of bounds
                if torch.max(batch['input'])> 1683:
                    continue
                ...
                logp, mean, logv, z = model(batch['input'],batch['labels'], batch['length']) #Add labels here!!
