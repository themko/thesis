...
class SentenceCVAE(nn.Module):
    ...
    def forward(self, input_sequence,label_sequence, length):
        ...
        input_embedding2 = torch.cat((input_embedding,label_sequence2),dim=2)


        packed_input = rnn_utils.pack_padded_sequence(input_embedding2, sorted_lengths.data.tolist(), batch_first=True)
